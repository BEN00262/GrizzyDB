...
import { EnsureIsApiKeyValid, EnsureIsAuthenticated } from '../../middlewares/index.js';
...
router.get('/installation/:database_reference', DatabaseController.get_monitor_installation);

router.get('/snapshots/:database_reference', DatabaseController.get_database_snapshots);
router.get('/snapshot/:database_reference', DatabaseController.get_database_snapshot);

router.get('/diffs/:main_schema/:base_schema?', DatabaseController.generate_schema_diffs);
