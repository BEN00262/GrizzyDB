...
// somehow pass this down
// export const system_db = 'GD_411YE4EPHK2H8EE';

export const admin = (system_db) => {
  return {
    ...
    server_status: r.db('rethinkdb').table('server_status'),
    server_status_id: r
      .db('rethinkdb')
    ...
    table_status: r.db('rethinkdb').table('table_status'),
    table_status_id: r
      .db(system_db)
